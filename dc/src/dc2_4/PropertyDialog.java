...
public class PropertyDialog extends JDialog {
    ...
    private JComboBox<Property.AppColor>  timeColorCombo;
    private DefaultComboBoxModel<Property.AppColor> timeColorComboModel;
    private JComboBox<Property.AppColor>  backgroundColorCombo;
    private DefaultComboBoxModel<Property.AppColor> backgroundColorModel;
    ...
    private void makeTimeColorChoice () {
        ...
        timeColorCombo.setRenderer(new ColorBoxRenderer());
        Property.AppColor[] colors = Property.getAppColors();
        for (Property.AppColor color : colors) {
            timeColorComboModel.addElement(color);
        }
        timeColorCombo.setSelectedItem(frame.getProperty().getTimeAppColor());
        timeColorChip = new ColorChipPanel(frame.getProperty().getTimeColor());
        timeColorCombo.addActionListener((e) -> {
            timeColorChip.setBackgroundColor(getColorByColorName((Property.AppColor) timeColorComboModel.getSelectedItem()));
        });
    }
    ...
    private void makeBackgroundColorChoice () {
        ...
        backgroundColorCombo.setRenderer(new ColorBoxRenderer());
        Property.AppColor[] colors = Property.getAppColors();
        for (Property.AppColor color : colors) {
            backgroundColorModel.addElement(color);
        }
        backgroundColorCombo.setSelectedItem(frame.getProperty().getBackgroundAppColor());
        backgroundColorChip = new ColorChipPanel(frame.getProperty().getBackgroundColor());
        backgroundColorCombo.addActionListener((e) -> {
            backgroundColorChip.setBackgroundColor(getColorByColorName((Property.AppColor) backgroundColorModel.getSelectedItem()));
        });

    }

    private Color getColorByColorName(Property.AppColor colorName) {
        for (Property.AppColor appColor : Property.getAppColors()) {
            if (colorName.getName().equals(appColor.getName())) {
    ...
    public Property.AppColor getChoosedTimeColor () {
        return (Property.AppColor) timeColorCombo.getSelectedItem();
    }

    public Property.AppColor getChoosedBackgroundColor () {
        return (Property.AppColor) backgroundColorCombo.getSelectedItem();
    }
